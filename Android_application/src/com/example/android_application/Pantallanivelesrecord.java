...
public class Pantallanivelesrecord extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.pantallarecodsniveles);
	...
	public void onClick(View v) {
		...
		case R.id.btFacil:
			...
			Intent llama_pantalla_facil = new Intent(
					"com.example.android_application.Record");
